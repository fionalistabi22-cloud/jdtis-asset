...
// Cannot reset password for Super Admin
if ($user['peranan_id'] === 1) {
    die("Anda tidak boleh reset kata laluan Super Admin");
}
...
<head>
    ...
    <title>Reset Kata Laluan - Admin Wilayah JTDIS</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.10.0/font/bootstrap-icons.css">
    <link rel="stylesheet" href="../admin-wilayah.css">
</head>
<body class="admin-wilayah page-reset-password">
